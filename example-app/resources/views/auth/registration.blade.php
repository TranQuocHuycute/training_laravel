...
@csrf
<div class="form-group mb-3">
<input type="text" placeholder="phonemunber" id="phonemunber" class="form-control" name="phonemunber"
 autofocus>
@if ($errors->has('phonemunber'))
<span class="text-danger">{{ $errors->first('phonemunber') }}</span>
@endif
</div>
